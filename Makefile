...
#    Updated: 2021/10/23 11:57:38 by cmaginot         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
NAME=so_long
...
CMLXFLAGS= -I$(MLX) -L/usr/lib -lXext -lX11 -L$(MLX) -lm -lz
RM=rm -f
...
$(NAME): $(OBJS)
	...
	make -C $(GNL) bonus
	make -C $(MLX)
	$(CC) $(CFLAGS) $(CMLXFLAGS) -o $@ $^ $(LIBFT)/libft.a $(GNL)/get_next_line.a $(MLX)/mlx.h $(MLX)/mlx_int.h $(MLX)/libmlx_Linux.a
