...
> advenced push_swap have some improvement, like outers wall, dynamic backgrounds, following player, new pickup (key), new obstacles (Door), and two types of ennemy.
